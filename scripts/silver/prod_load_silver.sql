...
WARNING:
    This procedure truncates all silver tables before reloading them. Any data
    manually inserted or modified directly in the silver tables will be
    permanently lost. Ensure the bronze tables are up to date and correct
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 
	        ...
	        sls_cust_id,
	        CASE 
		        WHEN LEN(sls_order_dt) != 8 OR sls_order_dt NOT BETWEEN 19000101 AND 20300101 THEN NULL
		        ELSE CAST(CAST(sls_order_dt AS VARCHAR) AS DATE)
	        END sls_order_dt,
	        CASE 
		        WHEN LEN(sls_ship_dt) != 8 OR sls_ship_dt NOT BETWEEN 19000101 AND 20300101 THEN NULL
		        ELSE CAST(CAST(sls_ship_dt AS VARCHAR) AS DATE)
	        END sls_ship_dt,
	
	        CASE 
		        WHEN LEN(sls_due_dt) != 8 OR sls_due_dt NOT BETWEEN 19000101 AND 20300101 THEN NULL
	        ...
	        CASE 
		        ...
		        ELSE sls_sales
	        END sls_sales,
	        NULLIF(ABS(sls_quantity),0)  sls_quantity,
	        CASE 
